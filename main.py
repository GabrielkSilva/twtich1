...
twitch_miner = TwitchChannelPointsMiner(
    username="pingtvk",
    password="27995767*",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1269664021536178186/Rc9sddx-hEQu_6AHv7Ygg3OP_4J4fV6WsXxbMYVcxz3XpBsQKZ00zg8UbWedvPa7thIU",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION],                                  # Only these events will be sent to the chat
        ),
        webhook=Webhook(
